...
@AllArgsConstructor
@Entity
@Table(name = "grupo_producto_sba", schema = "public")
@Where(clause = "activo = true")
public class GrupoProductoSba implements Serializable{
...
private static final long serialVersionUID = 1L;
	...
	@JoinColumn(name = "id_area_estrategia_negocio", referencedColumnName = "id")
	@ManyToOne
	private PaAreaEstrategiaNegocio areaEstrategia;
