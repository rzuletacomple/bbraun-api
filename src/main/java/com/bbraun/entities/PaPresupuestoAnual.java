...
@AllArgsConstructor
@Entity
@Table(name = "pa_presupuesto_anual", schema = "configuracion")
@Where(clause = "activo = true")
public class PaPresupuestoAnual implements Serializable{
	...
	@Basic(optional = false)
	@Column(name = "presupuesto_venta")
	private BigDecimal presupuestoVenta;

	@Basic(optional = false)
	@Column(name = "presupuesto_recaudo")
