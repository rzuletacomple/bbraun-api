...
@AllArgsConstructor
@Entity
@Table(name = "pa_subtipo_cliente", schema = "configuracion")
@Where(clause = "activo = true")
public class PaSubTipoCliente implements Serializable{
	...
	@JoinColumn(name = "id_categoria_cliente", referencedColumnName = "id")
	@ManyToOne
	private PaCategoriaCliente categoriaCliente;
